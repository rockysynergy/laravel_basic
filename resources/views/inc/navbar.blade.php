   ...
   <div class="row">
     ...
     <div class="col-sm-4 offset-md-1 py-4">
       ...
       <ul class="list-unstyled">
         <li class="{{Request::is('/') ? 'active' : ''}}"><a href="/" class="text-white">Home</a></li>
         <li class="{{Request::is('about') ? 'active' : ''}}"><a href="/about" class="text-white">About</a></li>
         <li class="{{Request::is('contact') ? 'active' : ''}}"><a href="/contact" class="text-white">Contact</a></li>
       </ul>
     </div>
   </div>
 </div>
